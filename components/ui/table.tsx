...
const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("[&_tr:last-child]:border-0 border-b border-border", className)} {...props} />
  ),
)
...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot
      ref={ref}
      className={cn(
        "bg-background font-medium text-muted-foreground [&_tr:last-child]:border-0 border-t border-border",
        className,
      )}
      {...props}
    />
