      ...
      <main className="container mx-auto px-4 py-8 md:py-16">
        ...
        <section className="mb-16 md:mb-24 text-center">
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            About <span className="text-[#FFA500]">Club Bink</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              ...
              className={cn(
                ...
                "w-full sm:w-auto bg-[#FFA500] text-black hover:bg-[#FF9000]",
              )}
            >
              Get Started
            </Link>
            <Link
              ...
              className={cn(
                ...
                "w-full sm:w-auto border-[#FFA500] text-[#FFA500] hover:bg-[#FFA500] hover:text-black",
              )}
            >
              View Roadmap
            </Link>
        ...
        <section className="mb-16 md:mb-24 bg-[#2A2A2A] rounded-lg overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-6 md:p-8 lg:p-12">
              ...
              <Link
                href="/stacker-landing"
                className={cn(buttonVariants({ size: "lg" }), "w-full bg-[#FFA500] text-black hover:bg-[#FF9000]")}
              >
                Try Stacker Demo
              </Link>
            </div>
              ...
              <div key={i} className="text-center">
                ...
                <div className="flex justify-center space-x-4">
                  {i === 1 ? (
                    <>
                      <a
                        href="https://github.com/satoshisound"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-400 hover:text-[#FFA500] transition-colors"
                        aria-label="Brenda Reyes GitHub"
                      >
                        <Github className="h-5 w-5" />
                      </a>
                      <a
                        href="https://x.com/satoshisound"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-400 hover:text-[#FFA500] transition-colors"
                        aria-label="Brenda Reyes Twitter"
                      >
