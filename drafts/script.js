...
window.onload = function() {
    ...
    document.getElementById('buyerOnboardingStep4').style.display = 'none';
...
// Move from step 3 to step 4 in buyer onboarding
// Smoothly scroll to step 4
document.getElementById('nextStepBuyerOnboarding3').addEventListener('click', function() {
    document.getElementById('buyerOnboardingStep3').style.display = 'none';
    document.getElementById('buyerOnboardingStep4').style.display = 'block';
    window.scrollTo({ top: document.getElementById('buyerOnboardingStep4').offsetTop, behavior: 'smooth' });
});
...
// Move back from step 4 to step 3 in buyer onboarding
// Smoothly scroll to step 3
document.getElementById('backStepBuyerOnboarding4').addEventListener('click', function() {
    document.getElementById('buyerOnboardingStep4').style.display = 'none';
    document.getElementById('buyerOnboardingStep3').style.display = 'block';
    window.scrollTo({ top: document.getElementById('buyerOnboardingStep3').offsetTop, behavior: 'smooth' });
});
